                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current ? 'bg-custom-yellow text-white' : 'text-gray-300 hover:bg-custom-yellow hover:text-white',
                  ...
                  <div>
                    <Menu.Button className="bg-gray-800 flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
                      ...
                      <img
                        ...
                        alt=""
                      />
                      <span className="text-white p-1 text-base">Mohit Bisht</span>
                    </Menu.Button>
                  </div>
                  <Transition
                    as={Fragment}
