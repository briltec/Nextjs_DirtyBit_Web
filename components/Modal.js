          ...
          <>
            ...
            <div className="p-3  mt-2 text-center space-x-4 md:block">
              <Link href="/auth/signin">
                <a className="mb-2 md:mb-0 bg-custom-indigo px-5 py-2 text-sm shadow-sm font-medium tracking-wider border text-white rounded-full hover:shadow-lg hover:bg-indigo-700 transition ease-out">
                  Sign In
                </a>
              </Link>
            </div>
