...
export default function Example() {
  return (
    <>
    <div style={{zIndex:-999}} className="relative bg-purple-400 h-screen w-screen customHero">
            ...
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-thin text-gray-900 sm:text-xs md:text-6xl">
                ...
                <Typewriter
                                    options={{loop: true}}
                                    onInit={(typewriter) => {
                                        typewriter.typeString('Hello Coders')
                                        .pauseFor(1500)
                                        .deleteAll()
                                        typewriter.typeString('Learn Coding with us')
                                        .pauseFor(1500)
                                        .deleteAll()
                                        typewriter.typeString('Start your journey now')
                                        .pauseFor(1500)
                                        .deleteAll()
                                        .start();
                                    }}
                ...
                <span className="block text-white font-light xl:block mt-5 text-4xl">Be a Coder with us.</span>
              </h1>
