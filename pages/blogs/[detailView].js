    ...
    return (
        <div className="container mx-auto lg:p-10 p-6 w-full">
            <div className="flex flex-col space-y-9 lg:mx-56">
                <Image className="object-contain" src={bg} height={300} width={600} layout="responsive"/>
                <motion.div animate={{ y: [20, 0, 0] }}>
                    <header className="font-extrabold lg:text-5xl text-4xl w-full"><h2>Top 10 ReactJS Libraries + Bonus Tips</h2></header>
                </motion.div>
                <div className="flex items-center space-x-2">
                    <div className="rounded-full  p-1 pb-[-3rem] border border-custom-yellow flex">
                        <Image className="rounded-full object-cover" src={'https://lh3.googleusercontent.com/ogw/ADea4I5wIPGFJSysHMWa6CyMkW0ABbNxUasYYCCG2pZhpQ=s64-c-mo'} width={40} height={40}  />
                    </div>
                    <p className="text-custom-yellow font-semibold">Mohit Bisht</p>
                    <p className="text-gray-400">Nov 11 . 4 min read</p>
                    <p><Star/></p>
                </div>   
