...
function changePassword() {
    return (
        ...
        <div class="py-12 px-12 bg-white rounded-2xl shadow-xl z-20">
            ...
            <div class="space-y-4">
                <input type="text" placeholder="Enter your registerd email" class="block text-lg py-3 px-4 rounded-lg w-full border outline-none text-black" />
        </div>
                <div class="flex flex-col justify-center items-center mt-6">
                    <button class="py-3 w-64 text-xl md:block text-white bg-custom-yellow2 rounded-2xl">Create Account</button>
